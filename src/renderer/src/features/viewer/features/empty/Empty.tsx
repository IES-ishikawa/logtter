...
export function Empty(): JSX.Element {
  const handleClick = (): void => {
    window.api.sendToMain.menuEvent(CommandId.openFile)
  }
  return (
    <Box
      sx={{
    ...
    >
      ...
      <Box display="flex" alignItems="center" justifyContent="center">
        <Button onClick={handleClick}>ファイルを開く</Button>
        <Typography>Ctrl + O</Typography>
      </Box>
      <Divider />
      <Typography>またはここにファイルをドラッグ＆ドロップ</Typography>
    </Box>
  )
}
